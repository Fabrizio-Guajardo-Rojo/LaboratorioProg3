...
<html>
    ...
    <body>
        ...
        <div id="show-formulario" class="content scaffold-show" role="main">
            ...
            <f:display bean="formulario" />
            <g:form resource="${this.formulario}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.formulario}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
