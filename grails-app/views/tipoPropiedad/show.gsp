...
<html>
    ...
    <body>
        ...
        <div id="show-tipoPropiedad" class="content scaffold-show" role="main">
            ...
            <f:display bean="tipoPropiedad" />
            <g:form resource="${this.tipoPropiedad}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tipoPropiedad}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
                </fieldset>
            </g:form>
        </div>
    </body>
