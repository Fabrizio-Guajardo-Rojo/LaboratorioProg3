                        ...
                        <div class="col-lg-12 comment-form">
                            <g:form class="row contact_form" novalidate="novalidate" name="formularioPropiededad" action="formularioPropiedadGuardarAlta">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="email_formulario">Email:</label> <input type="text" class="form-control" id="email_formulario" name="email_formulario" placeholder="Mensaje" required=""/>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-12 text-right">
                                    <button type="submit" value="submit" class="banner_btn">Enviar</button>
                                </div>
                            </g:form>
                        </div>
                    </div>
